<?php
    ...
    <form action="" id="ct_contact" method="post">
        ...
        <p>
            <input type="submit" name="form_submit" value="<?php echo esc_attr( $atts['subject'] ); ?>" />
        </p>
    </form>
    <?php
        }
...
<?php
	...
	<table>
		<tr>
			<td>Teaser Url:</td>
			<td>
				<input type="text" name="movie_name" value="<?php echo ct_save_movie_metabox_value( $movie_name ); ?>" />
			</td>
		</tr>
		<tr>
			<td>Release Year:</td>
			<td>
				<input type="text" name="release_year" value="<?php echo ct_save_movie_metabox_value( $release_year ); ?>" />
			</td>
		</tr>
		<tr>
			<td>Actor:</td>
			<td>
				<input type="text" name="actor_name" value="<?php echo ct_save_movie_metabox_value( $actor_name ); ?>" />
			</td>
		</tr>
